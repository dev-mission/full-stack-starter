    ...
    return (
        ...
        <div className="row">
          ...
          <Link className="btn btn-primary" to="/">
            ...
            <p className="text-center" >Database fundamentals cover basics of data, modeling databases, architecture,
Structured Query Language commands and query design.</p>
