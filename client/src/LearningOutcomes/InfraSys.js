    ...
    return (
        ...
        <div className="row">
          <div className="col-md-6" id="rightRegister" style={{display: 'flex',  justifyContent:'center', alignItems:'center', height: '100vh'}}>
            <h1>Infrastructure and Systems</h1>
          ...
          <Link className="btn btn-primary" to="/">
            ...
            <p className="text-center" >Infrastructure and systems cover the different components of systems such as servers,
storage, network, security, software, switches, and operating systems.</p>
            ...
            <div className="list-group">
              <table className="table table-hover table-dark">
                  ...
                  <tbody>
                      ...
                      <tr className="bg-primary text-center">
                          <td>Switches and Routers</td>
                          {user && <td><button className="btn btn-warning">Update</button></td>}
                          <td><Link className="nav-link" href="/infra_and_systems" to="/infra_and_systems"><button className="btn btn-primary">Learn</button></Link></td>
                      </tr>
                      <tr className="bg-primary text-center">
                          <td>Network, Security, and Software</td>
                          {user && <td><button className="btn btn-warning">Update</button></td>}
                          <td><Link className="nav-link" href="/infra_and_systems" to="/infra_and_systems"><button className="btn btn-primary">Learn</button></Link></td>
                      </tr>
                  </tbody>
