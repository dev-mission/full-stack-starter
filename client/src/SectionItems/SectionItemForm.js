              ...
              {sectionItem && (
                <form onSubmit={onSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      className={classNames('form-control', { 'is-invalid': error?.errorsFor?.('subtitle') })}
                      id="subtitle"
                      name="subtitle"
                      onChange={onChange}
                      type="text"
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      className={classNames('form-control', { 'is-invalid': error?.errorsFor?.('place') })}
                      id="place"
                      name="place"
                      onChange={onChange}
                      type="text"
                      value={sectionItem.place}
                    />
                  ...
                  <div className="mb-3">
                    ...
                    <textarea
                      className={classNames('form-control', { 'is-invalid': error?.errorsFor?.('about') })}
                      id="about"
                      name="about"
                      onChange={onChange}
                      value={sectionItem.about}></textarea>
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      className={classNames('form-control', { 'is-invalid': error?.errorsFor?.('startedAt') })}
                      id="startedAt"
                      name="startedAt"
                      onChange={onChange}
                      pattern="[0-9]{4}-[0-9]{2}"
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      className={classNames('form-control', { 'is-invalid': error?.errorsFor?.('endedAt') })}
                      id="endedAt"
                      name="endedAt"
                      onChange={onChange}
                      pattern="[0-9]{4}-[0-9]{2}"
